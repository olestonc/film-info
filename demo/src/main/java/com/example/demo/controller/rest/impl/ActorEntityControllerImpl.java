...
public class ActorEntityControllerImpl implements ActorControllerRest {
    ...
    public NetflixResponse<ActorRestPost> createActor(@RequestBody final ActorRestPost actor) throws NetflixException {
    ...
    public NetflixResponse<ActorRestPost> updateActor(@RequestBody final ActorRestPost actor) throws NetflixException {
        return new NetflixResponse<>(HttpStatus.OK.toString(), String.valueOf(HttpStatus.OK.value()),
